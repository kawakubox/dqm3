...
class SkillSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill_set" do
    assert_difference("SkillSet.count") do
      post skill_sets_url, params: { skill_set: { point: @skill_set.point, skill_group_id: @skill_set.skill_group_id, skill_id: @skill_set.skill_id } }
    end
  ...
  test "should update skill_set" do
    patch skill_set_url(@skill_set), params: { skill_set: { point: @skill_set.point, skill_group_id: @skill_set.skill_group_id, skill_id: @skill_set.skill_id } }
