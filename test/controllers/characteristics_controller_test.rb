...
class CharacteristicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create characteristic" do
    assert_difference("Characteristic.count") do
      post characteristics_url, params: { characteristic: { description: @characteristic.description, name: @characteristic.name } }
    end
  ...
  test "should update characteristic" do
    patch characteristic_url(@characteristic), params: { characteristic: { description: @characteristic.description, name: @characteristic.name } }
